...
#标题
Label(root, text='欢迎使用拍立淘',  bg="red",font=ft1).pack(side=TOP)
...
var2.set(r'C:\Users\HDC\Desktop')
e2.pack(side=RIGHT)

var3 = StringVar()
e3 = Entry(frm_B0,width=5,textvariable=var3)
s=Scale(frm_B0,label="相似度", from_=0,to=100,orient=HORIZONTAL,
